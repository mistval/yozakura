...
title: Memory System
sidebar_position: 6
description: How Yozakura's memory system gives AI characters persistent memories, relationships, goals, and gossip — creating continuity and narrative momentum across every conversation.
keywords:
  - yozakura memory
  - ai memory system
