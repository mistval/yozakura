...
const settingsSchema = z.object({
  ...
  intelligentChatEndGroupMinLength: z.number(),
  intelligentChatEndGroupMaxLength: z.number(),
...
const DEFAULT_SETTINGS: Settings = {
  ...
  intelligentChatEndMaxLength: 24,
  intelligentChatEndGroupMinLength: 10,
  intelligentChatEndGroupMaxLength: 40,
