...
export default function MapModal() {
  const { open, closeMap } = useMapModal();
  const zIndex = useModalStackZIndex('map');
  ...
  return (
    <Modal open={open} onClose={closeMap} className="flex items-center justify-center p-4" zIndex={zIndex}>
      <div
        className="flex w-full max-w-6xl flex-col overflow-hidden rounded-sm border bg-emphasized shadow-xs"
        style={{ height: '88vh' }}
      >
